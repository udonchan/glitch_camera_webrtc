...
var _canvas;
var _glitch_view;
var _jpeg_quality_label;
var _glitch_amount_label;
...
setTimeout(function() {
	...
	_jpeg_quality_label = document.getElementById("jpeg_quality_label")
	_glitch_amount_label = document.getElementById("glitch_amount_label");
        initControlForm()
...
function initControlForm() {
	...
	_jpeg_quality_label.innerHTML = _jpeg_quality = document.control_form.jpeg_quality.value;
    }; 
    _jpeg_quality_label.innerHTML = document.control_form.jpeg_quality.value;
	...
	_glitch_amount_label.innerHTML = _glitch_amount = document.control_form.glitch_amount.value;
    };
    _glitch_amount_label.innerHTML = document.control_form.glitch_amount.value;
}
